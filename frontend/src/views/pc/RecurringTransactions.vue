      ...
      <el-table-column label="操作" width="200" fixed="right">
        <template #default="scope">
          <div class="action-buttons">
            <el-button size="small" @click="editTransaction(scope.row)">
              编辑
            </el-button>
            ...
            <div class="postings-summary">
              ...
              <div class="balance-info">
                ...
                <span
                  :class="[
                    'balance-amount',
                    validatePostings() ? 'balanced' : 'unbalanced',
                  ]"
                >
                  {{ (getPostingsSum() || 0).toFixed(2) }}
                </span>
                <el-tag v-if="validatePostings()" type="success" size="small"
                  >平衡</el-tag
                >
...
import { Plus, Timer, VideoPlay } from "@element-plus/icons-vue";
...
const saveTransaction = async () => {
  ...
  try {
    ...
    const dataToSend = {
      ...
      end_date: form.end_date || null, // 空字符串转为null，避免422错误
