  ...
  <div class="recurring-detail">
    ...
    <div v-else-if="recurringData" class="detail-content">
      ...
      <van-cell-group title="周期设置" inset>
        <van-cell
          title="周期类型"
          :value="getRecurrenceTypeText(recurringData.recurrence_type)"
        />
        <van-cell
          v-if="
            recurringData.recurrence_type === 'weekly' &&
            recurringData.weekly_days?.length
          "
          title="执行日期"
        ...
        <van-cell
          v-if="
            ...
            recurringData.monthly_days?.length
          "
          title="执行日期"
        ...
        <van-cell
          title="结束日期"
          :value="recurringData.end_date || '无期限'"
        />
        <van-cell
          title="最后执行"
          :value="recurringData.last_executed || '未执行'"
        />
        <van-cell
          title="下次执行"
          :value="recurringData.next_execution || '未安排'"
        />
      </van-cell-group>
      ...
      <div class="action-buttons">
        <van-button type="primary" size="large" block @click="editRecurring">
          编辑
        </van-button>
        ...
        <van-button type="default" size="large" block @click="viewLogs">
          查看执行日志
        </van-button>
